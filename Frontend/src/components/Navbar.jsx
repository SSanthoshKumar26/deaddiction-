                ...
                <div className={`flex items-center justify-between transition-all duration-300 ${isScrolled ? 'py-1.5' : 'py-2 lg:py-3'}`}>
                    ...
                    <div className="flex items-center gap-4">
                        <button
                            ...
                            className="lg:hidden flex items-center justify-center w-9 h-9 rounded-xl bg-surface-50 text-surface-700 border border-surface-200 hover:bg-surface-100 transition-all"
